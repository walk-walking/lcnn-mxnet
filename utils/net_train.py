...
import utils.net_generator as net_generator
...
def train_net(cfg):
    ...
    lr_sch = mx.lr_scheduler.FactorScheduler(cfg['lr_step'], cfg['lr_factor'])  #每cfg['lr_step']步后 学习率 *= cfg['lr_factor'] 
    ...
    train_iter_resized = mx.io.ResizeIter(train_iter, cfg['epoch_size'], reset_internal=False)  #epoch_size 指定每次epoch能跑的batch次数
